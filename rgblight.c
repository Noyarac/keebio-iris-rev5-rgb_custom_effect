...
#    endif
#    ifdef RGBLIGHT_EFFECT_MY_CUSTOM_MODE
        else if (rgblight_status.base_mode == RGBLIGHT_MODE_MY_CUSTOM_MODE) {
            // my custom mode
            interval_time = RGBLIGHT_EFFECT_MY_CUSTOM_MODE_INTERVAL;
            effect_func   = (effect_func_t)rgblight_effect_my_custom_mode;
        }
#    endif
...
#ifdef RGBLIGHT_EFFECT_MY_CUSTOM_MODE
#    define COLOR_FADE_SIZE 136
#    define STEP_PAD 6
const uint8_t COLOR_FADE[COLOR_FADE_SIZE][3] = {{103,241,215},{88,166,192},{59,171,170},{32,207,181},{21,242,238},{21,242,242},{21,242,246},{21,242,250},{21,242,252},{21,242,250},{21,242,248},{21,242,246},{21,242,244},{21,242,242},{21,242,240},{21,242,238},{26,226,209},{32,207,181},{45,182,159},{59,171,170},{74,160,181},{88,166,192},{97,206,203},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},{103,241,215},};

void rgblight_effect_my_custom_mode(animation_status_t *anim) {
    sethsv(COLOR_FADE[(anim->pos)][0], COLOR_FADE[(anim->pos)][1], COLOR_FADE[(anim->pos)][2], (rgb_led_t *)&led[2]);
    sethsv(COLOR_FADE[(anim->pos)][0], COLOR_FADE[(anim->pos)][1], COLOR_FADE[(anim->pos)][2], (rgb_led_t *)&led[3]);
    sethsv(COLOR_FADE[(anim->pos)][0], COLOR_FADE[(anim->pos)][1], COLOR_FADE[(anim->pos)][2], (rgb_led_t *)&led[8]);
    sethsv(COLOR_FADE[(anim->pos)][0], COLOR_FADE[(anim->pos)][1], COLOR_FADE[(anim->pos)][2], (rgb_led_t *)&led[9]);
    sethsv(COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][0], COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][1], COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][2], (rgb_led_t *)&led[1]);
    sethsv(COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][0], COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][1], COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][2], (rgb_led_t *)&led[4]);
    sethsv(COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][0], COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][1], COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][2], (rgb_led_t *)&led[7]);
    sethsv(COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][0], COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][1], COLOR_FADE[(anim->pos + STEP_PAD) % COLOR_FADE_SIZE][2], (rgb_led_t *)&led[10]);
    sethsv(COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][0], COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][1], COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][2], (rgb_led_t *)&led[0]);
    sethsv(COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][0], COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][1], COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][2], (rgb_led_t *)&led[5]);
    sethsv(COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][0], COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][1], COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][2], (rgb_led_t *)&led[6]);
    sethsv(COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][0], COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][1], COLOR_FADE[(anim->pos + STEP_PAD * 2) % COLOR_FADE_SIZE][2], (rgb_led_t *)&led[11]);
    rgblight_set();

    if (anim->pos > (COLOR_FADE_SIZE - 2)) {
        anim->pos = 0;
    } else {
        anim->pos += 1;
    }
